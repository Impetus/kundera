...
public class MailUtils
{
    ...
    {
        onSendEmail(delta, operationType, dataStore, new String[] { "shaheed.hussain@impetus.co.in",
    ...
    {
        onSendEmail(delta, operationType, dataStore, new String[] { "kuldeep.mishra@impetus.co.in",
