...
public class EntityListenersProcessor implements MetadataProcessor {
    ...
    private static final List<Class<? extends Annotation>> JPAListenersAnnotations = Arrays.asList(PrePersist.class, PostPersist.class, PreUpdate.class, PostUpdate.class, PreRemove.class,
