...
public class StudentOracleNoSQLBooleanPrimitiveTest extends OracleNoSQLBase
{
    ...
    public void testPersist(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanPrimitive studentMax = new StudentOracleNoSQLBooleanPrimitive();
        ...
        StudentOracleNoSQLBooleanPrimitive studentMin = new StudentOracleNoSQLBooleanPrimitive();
    ...
    public void testFindById(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanPrimitive studentMax = em.find(StudentOracleNoSQLBooleanPrimitive.class, getMaxValue(boolean.class));
        ...
        StudentOracleNoSQLBooleanPrimitive studentMin = em.find(StudentOracleNoSQLBooleanPrimitive.class, getMinValue(boolean.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLBooleanPrimitive student = em.find(StudentOracleNoSQLBooleanPrimitive.class, getMaxValue(boolean.class));
        ...
        StudentOracleNoSQLBooleanPrimitive newStudent = em.find(StudentOracleNoSQLBooleanPrimitive.class, getMaxValue(boolean.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        String query;
        Query q;
        List<StudentOracleNoSQLBooleanPrimitive> students;
        int count;
        em = emf.createEntityManager();
        ...
        count = 0;
        for (StudentOracleNoSQLBooleanPrimitive student : students)
        {
    ...
    public void testDelete(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanPrimitive studentMax = em.find(StudentOracleNoSQLBooleanPrimitive.class, getMinValue(boolean.class));
        Assert.assertNotNull(studentMax);
        ...
        studentMax = em.find(StudentOracleNoSQLBooleanPrimitive.class, getMinValue(boolean.class));
    ...
    private void deleteNamed(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanPrimitive newStudent = em.find(StudentOracleNoSQLBooleanPrimitive.class, getRandomValue(boolean.class));
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLBooleanPrimitive> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(2, students.size());
        int count = 0;
        for (StudentOracleNoSQLBooleanPrimitive student : students)
