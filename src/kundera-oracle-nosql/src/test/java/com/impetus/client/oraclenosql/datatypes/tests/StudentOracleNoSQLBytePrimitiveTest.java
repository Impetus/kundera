...
import com.impetus.client.oraclenosql.datatypes.entities.StudentOracleNoSQLBytePrimitive;

public class StudentOracleNoSQLBytePrimitiveTest extends OracleNoSQLBase
{
    ...
    public void testPersist(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBytePrimitive studentMax = new StudentOracleNoSQLBytePrimitive();
        ...
        StudentOracleNoSQLBytePrimitive studentMin = new StudentOracleNoSQLBytePrimitive();
        ...
        StudentOracleNoSQLBytePrimitive student = new StudentOracleNoSQLBytePrimitive();
    ...
    public void testFindById(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBytePrimitive studentMax = em.find(StudentOracleNoSQLBytePrimitive.class, getMaxValue(byte.class));
        ...
        StudentOracleNoSQLBytePrimitive studentMin = em.find(StudentOracleNoSQLBytePrimitive.class, getMinValue(byte.class));
        ...
        StudentOracleNoSQLBytePrimitive student = em.find(StudentOracleNoSQLBytePrimitive.class, getRandomValue(byte.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLBytePrimitive student = em.find(StudentOracleNoSQLBytePrimitive.class, getMaxValue(byte.class));
        Assert.assertNotNull(student);
        ...
        StudentOracleNoSQLBytePrimitive newStudent = em.find(StudentOracleNoSQLBytePrimitive.class, getMaxValue(byte.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        String query;
        Query q;
        List<StudentOracleNoSQLBytePrimitive> students;
        int count;
        em = emf.createEntityManager();
        ...
        count = 0;
        for (StudentOracleNoSQLBytePrimitive student : students)
        {
    ...
    private void findByNameAndAgeWithOrClause()
    {
        ...
        int count;
        em = emf.createEntityManager();
        query = "Select s From StudentOracleNoSQLBytePrimitive s where s.name = Kuldeep and s.age > " + getMinValue(short.class);
        q = em.createQuery(query);
        students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(1, students.size());
    ...
    public void testDelete(boolean useSameEm)
    {
        ...
        studentMax = em.find(StudentOracleNoSQLBytePrimitive.class, getMaxValue(byte.class));
    ...
    private void deleteNamed(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBytePrimitive newStudent = em.find(StudentOracleNoSQLBytePrimitive.class, getRandomValue(byte.class));
    ...
    private void findByNameAndAgeGTAndLT()
    {
        ...
        int count;
        em = emf.createEntityManager();
        query = "Select s From StudentOracleNoSQLBytePrimitive s where s.name = Amresh and s.age > " + getMinValue(short.class)
                + " and s.age < " + getMaxValue(short.class);
        q = em.createQuery(query);
        students = q.getResultList();
        Assert.assertNotNull(students);
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLBytePrimitive> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(3, students.size());
        int count = 0;
        for (StudentOracleNoSQLBytePrimitive student : students)
