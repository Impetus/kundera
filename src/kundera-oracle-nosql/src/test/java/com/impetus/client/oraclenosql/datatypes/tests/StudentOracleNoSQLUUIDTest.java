...
public class StudentOracleNoSQLUUIDTest extends OracleNoSQLBase
{
    ...
    private void testNativeQuery(boolean b)
    {
        ...
        Query q = em.createNativeQuery(s, StudentOracleNoSQLUUID.class);
        List<StudentOracleNoSQLUUID> results = q.getResultList();
    ...
    public void testPersist(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLUUID studentMax = new StudentOracleNoSQLUUID();
        ...
        StudentOracleNoSQLUUID studentMin = new StudentOracleNoSQLUUID();
        ...
        StudentOracleNoSQLUUID student = new StudentOracleNoSQLUUID();
    ...
    public void testFindById(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLUUID studentMax = em.find(StudentOracleNoSQLUUID.class, getMaxValue(UUID.class));
        ...
        StudentOracleNoSQLUUID studentMin = em.find(StudentOracleNoSQLUUID.class, getMinValue(UUID.class));
        ...
        StudentOracleNoSQLUUID student = em.find(StudentOracleNoSQLUUID.class, getRandomValue(UUID.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLUUID student = em.find(StudentOracleNoSQLUUID.class, getMaxValue(UUID.class));
        Assert.assertNotNull(student);
        ...
        StudentOracleNoSQLUUID newStudent = em.find(StudentOracleNoSQLUUID.class, getMaxValue(UUID.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        count = 0;
        for (StudentOracleNoSQLUUID student : students)
        {
    ...
    public void testDelete(boolean useSameEm)
    {
        ...
        studentMax = em.find(StudentOracleNoSQLUUID.class, getMaxValue(UUID.class));
    ...
    private void deleteNamed(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLUUID newStudent = em.find(StudentOracleNoSQLUUID.class, getRandomValue(UUID.class));
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLUUID> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(3, students.size());
        int count = 0;
        for (StudentOracleNoSQLUUID student : students)
