...
public class ThriftClientTest
{
    ...
    {
        JoinTableData joinTableData = new JoinTableData(OPERATION.INSERT, "PERSON_ADDRESS", "PERSON_ID", 
                "ADDRESS_ID", PersonMToM.class);
        
        Set<Object> values1 = new HashSet<Object>(); values1.add("A"); values1.add("B");        
        Set<Object> values2 = new HashSet<Object>(); values2.add("C"); values2.add("D");
