...
public interface Client {
	 ...
	 *             the exception
	 */
	void writeData(EntityManagerImpl em, EnhancedEntity e, EntityMetadata m)
			throws Exception;
	 ...
	 *             the exception
	 */
	<E> E loadData(EntityManagerImpl em, String key, EntityMetadata m)
			throws Exception;
	 ...
	 *             the exception
	 */
	<E> List<E> loadData(EntityManagerImpl em, EntityMetadata m, String... keys)
			throws Exception;
	 ...
	 *             the exception
	 */
	Map<Bytes, List<SuperColumn>> loadEmbeddedObjects(String schema,
			String tableName, String... keys) throws Exception;
	...
	<E> List<E> loadData(EntityManagerImpl em, EntityMetadata m, Query query)
			throws Exception;
