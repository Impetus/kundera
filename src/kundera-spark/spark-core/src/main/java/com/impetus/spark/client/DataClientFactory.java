...
public class DataClientFactory
{
    ...
    /** The logger. */
    private static Logger logger = LoggerFactory.getLogger(DataClientFactory.class);

    /** The client pool. */
    private static Map<String, DataClient> clientPool = new HashMap<String, DataClient>();
     ...
     */
    public static DataClient getDataClient(String clientName)
    {
        ...
        try
        {
            DataClient dataClient = (DataClient) KunderaCoreUtils.createNewInstance(Class.forName(clientNameToClass
                    .get(clientName)));
