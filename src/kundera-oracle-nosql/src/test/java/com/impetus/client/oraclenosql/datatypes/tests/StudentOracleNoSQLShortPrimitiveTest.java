...
import com.impetus.client.oraclenosql.datatypes.entities.StudentOracleNoSQLShortPrimitive;
import com.impetus.kundera.metadata.model.KunderaMetadata;

public class StudentOracleNoSQLShortPrimitiveTest extends OracleNoSQLBase
{
    ...
    public void testPersist(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLShortPrimitive studentMax = new StudentOracleNoSQLShortPrimitive();
        ...
        StudentOracleNoSQLShortPrimitive studentMin = new StudentOracleNoSQLShortPrimitive();
        ...
        StudentOracleNoSQLShortPrimitive student = new StudentOracleNoSQLShortPrimitive();
    ...
    public void testFindById(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLShortPrimitive studentMax = em.find(StudentOracleNoSQLShortPrimitive.class, getMaxValue(Short.class));
        ...
        StudentOracleNoSQLShortPrimitive studentMin = em.find(StudentOracleNoSQLShortPrimitive.class, getMinValue(Short.class));
        ...
        StudentOracleNoSQLShortPrimitive student = em.find(StudentOracleNoSQLShortPrimitive.class, getRandomValue(Short.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLShortPrimitive student = em.find(StudentOracleNoSQLShortPrimitive.class, getMaxValue(Short.class));
        Assert.assertNotNull(student);
        ...
        StudentOracleNoSQLShortPrimitive newStudent = em.find(StudentOracleNoSQLShortPrimitive.class, getMaxValue(Short.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        String query;
        Query q;
        List<StudentOracleNoSQLShortPrimitive> students;
        int count;
        em = emf.createEntityManager();
        ...
        count = 0;
        for (StudentOracleNoSQLShortPrimitive student : students)
        {
    ...
    public void testDelete(boolean useSameEm)
    {
        ...
        studentMax = em.find(StudentOracleNoSQLShortPrimitive.class, getMaxValue(Short.class));
    ...
    private void deleteNamed(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLShortPrimitive newStudent = em.find(StudentOracleNoSQLShortPrimitive.class, getRandomValue(Short.class));
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLShortPrimitive> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(3, students.size());
        int count = 0;
        for (StudentOracleNoSQLShortPrimitive student : students)
