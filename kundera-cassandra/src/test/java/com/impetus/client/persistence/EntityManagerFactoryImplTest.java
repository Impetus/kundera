...
public class EntityManagerFactoryImplTest {
	 ...
	 * @param _PU1
	 */
	private void checkEMFPropertyAfterClosing(String _PU1,
			EntityManagerFactory emf) {
		Assert.assertFalse(emf.isOpen());
		Assert.assertNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getPersistenceUnitMetadata(_PU1));
		Assert.assertNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getPersistenceUnitMetadataMap().get(_PU1));
		Assert.assertNull(KunderaMetadata.INSTANCE.getClientMetadata(_PU1));
		Assert.assertNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getMetamodelMap().get(_PU1));
		Assert.assertNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getMetamodel(_PU1));
		Assert.assertNotNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getMetaModelBuilder(_PU1));
		Assert.assertNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getSchemaMetadata().getPuToSchemaMetadata().get(_PU1));
	}

	/**
	 * @param pu
	 */
	private void checkEMFPropertiesAfterCreating(String pu,
			EntityManagerFactory emf) {
		...
		Assert.assertFalse(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getPersistenceUnitMetadataMap().isEmpty());
		Assert.assertNotNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getPersistenceUnitMetadataMap().get(pu));
		Assert.assertNotNull(KunderaMetadata.INSTANCE.getClientMetadata(pu));
		Assert.assertFalse(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getMetamodelMap().isEmpty());
		Assert.assertNotNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getMetamodelMap().get(pu));
		Assert.assertNotNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getMetamodel(pu));
		Assert.assertNotNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getMetaModelBuilder(pu));
		Assert.assertNotNull(KunderaMetadata.INSTANCE.getApplicationMetadata()
				.getSchemaMetadata().getPuToSchemaMetadata().get(pu));
		Assert.assertNull(KunderaMetadata.INSTANCE.getClientMetadata(pu)
				.getLuceneIndexDir());
	}
