...
public class ArticleMongoTest {
	...
	public void testComplexQueries() {
		...
		query = em.createQuery(
				"select a from ArticleMongo a where a.category IN :category " + "order by a.createDate asc");
	...
	public void testJoins() {
		...
		// query = em.createQuery("select max(e.value) from ArticleMTO e where
		// e.article.priority < :priority");
	...
	public void testAggregation() {
		...
		query = em.createQuery(
				"select avg(a.priority), sum(a.priority), max(a.priority), min(a.priority) from ArticleMongo a");
		results = query.getResultList();
		...
		query = em.createQuery(
				"select sum(a.priority), a.category from ArticleMongo a group by a.category order by a.category");
		results = query.getResultList();
		...
		query = em.createQuery(
				"select sum(a.priority), a.category, avg(a.priority), min(a.priority) from ArticleMongo a group by a.category");
		results = query.getResultList();
		...
		query = em.createQuery(
				"select sum(a.priority), a.category from ArticleMongo a group by a.category order by sum(a.priority) desc");
		results = query.getResultList();
	...
	public void testCountAggregation() {
		...
		Query query = em.createQuery(
				"select sum(a.priority), count(a), a.category from ArticleMongo a group by a.category order by a.category");
		List results = query.getResultList();
