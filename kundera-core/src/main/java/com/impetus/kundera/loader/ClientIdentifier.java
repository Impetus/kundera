...
public class ClientIdentifier {
	...
	public ClientIdentifier(String[] contactNodes, int port, String keyspace,
			ClientType clientType, String persistenceUnit) {
	...
	public boolean equals(Object client) {
		if (!(client instanceof ClientIdentifier)) {
			...
			return proxy.getClientType().equals(this.clientType)
					...
					&& proxy.getNode().equals(this.getNode())
					&& proxy.getPersistenceUnit().equals(
