...
import com.impetus.client.oraclenosql.datatypes.entities.StudentOracleNoSQLBooleanWrapper;
import com.impetus.kundera.query.QueryHandlerException;

public class StudentOracleNoSQLBooleanWrapperTest extends OracleNoSQLBase
{
    ...
    public void testPersist(Boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanWrapper studentMax = new StudentOracleNoSQLBooleanWrapper();
        ...
        StudentOracleNoSQLBooleanWrapper studentMin = new StudentOracleNoSQLBooleanWrapper();
    ...
    public void testFindById(Boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanWrapper studentMax = em.find(StudentOracleNoSQLBooleanWrapper.class, getMaxValue(Boolean.class));
        ...
        StudentOracleNoSQLBooleanWrapper studentMin = em.find(StudentOracleNoSQLBooleanWrapper.class, getMinValue(Boolean.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLBooleanWrapper student = em.find(StudentOracleNoSQLBooleanWrapper.class, getMaxValue(Boolean.class));
        ...
        StudentOracleNoSQLBooleanWrapper newStudent = em.find(StudentOracleNoSQLBooleanWrapper.class, getMaxValue(Boolean.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        String query;
        Query q;
        List<StudentOracleNoSQLBooleanWrapper> students;
        int count;
        em = emf.createEntityManager();
        ...
        count = 0;
        for (StudentOracleNoSQLBooleanWrapper student : students)
        {
    ...
    public void testDelete(Boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanWrapper studentMax = em.find(StudentOracleNoSQLBooleanWrapper.class, getMinValue(Boolean.class));
        Assert.assertNotNull(studentMax);
        ...
        studentMax = em.find(StudentOracleNoSQLBooleanWrapper.class, getMinValue(Boolean.class));
    ...
    private void deleteNamed(Boolean useSameEm)
    {
        ...
        StudentOracleNoSQLBooleanWrapper newStudent = em.find(StudentOracleNoSQLBooleanWrapper.class, getRandomValue(Boolean.class));
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLBooleanWrapper> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(2, students.size());
        int count = 0;
        for (StudentOracleNoSQLBooleanWrapper student : students)
