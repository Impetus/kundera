...
public class GeneratedIdTest
{
    ...
    private void createTables() throws SQLException
    {
        ...
        try
        {
            cli.update("CREATE TABLE TESTDB.USERGENERATEDID (PERSON_ID INT GENERATED BY DEFAULT AS IDENTITY (START WITH 1), PERSON_NAME VARCHAR(256), ADDRESS_ID VARCHAR(150))");
        }
        catch (Exception e)
        {
            cli.update("DELETE FROM TESTDB.USERGENERATEDID");
        ...
        try
        {
            cli.update("CREATE TABLE TESTDB.ADDRESSGENERATEDID (ADDRESS_ID INT  GENERATED BY DEFAULT AS IDENTITY (START WITH 1), STREET VARCHAR(256))");
