...
public class StudentOracleNoSQLTimeTest extends OracleNoSQLBase
{
    ...
    public void testPersist(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLTime student = new StudentOracleNoSQLTime();
        ...
        StudentOracleNoSQLTime studentMax = new StudentOracleNoSQLTime();
        ...
        StudentOracleNoSQLTime studentMin = new StudentOracleNoSQLTime();
    ...
    public void testFindById(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLTime studentMax = em.find(StudentOracleNoSQLTime.class, getMaxValue(Time.class));
        ...
        StudentOracleNoSQLTime studentMin = em.find(StudentOracleNoSQLTime.class, getMinValue(Time.class));
        ...
        StudentOracleNoSQLTime student = em.find(StudentOracleNoSQLTime.class, getRandomValue(Time.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLTime student = em.find(StudentOracleNoSQLTime.class, getMaxValue(Time.class));
        Assert.assertNotNull(student);
        ...
        StudentOracleNoSQLTime newStudent = em.find(StudentOracleNoSQLTime.class, getMaxValue(Time.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        String query;
        Query q;
        List<StudentOracleNoSQLTime> students;
        int count;
        em = emf.createEntityManager();
        ...
        count = 0;
        for (StudentOracleNoSQLTime student : students)
        {
    ...
    public void testDelete(boolean useSameEm)
    {
        ...
        studentMax = em.find(StudentOracleNoSQLTime.class, getMaxValue(Time.class));
    ...
    private void deleteNamed(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLTime newStudent = em.find(StudentOracleNoSQLTime.class, getRandomValue(Time.class));
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLTime> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(3, students.size());
        int count = 0;
        for (StudentOracleNoSQLTime student : students)
