...
public class OracleNoSQLMinorKeyAllDataTypeTest
{
    ...
    {        
        ...
        PersonOracleNoSQLAllDataType person = new PersonOracleNoSQLAllDataType(1234567l, "Labs", false, 31, 'C', (byte) 8,
    ...
    private void assertPerson1(PersonOracleNoSQLAllDataType p)
    {
        ...
        Assert.assertEquals(new Date(Long
                .parseLong("1344079067623")), p.getEnrolmentTime());
        ...
        Assert.assertEquals(new Long(
                3634521523423L), p.getUniqueId());
        Assert.assertEquals(new Double(0.23452342343), p.getMonthlySalary());
        Assert.assertEquals(new java.sql.Date(new Date(Long
                .parseLong("1344079061111")).getTime()), p.getBirthday());
        Assert.assertEquals(new java.sql.Time(new Date(Long
                .parseLong("1344079062222")).getTime()), p.getBirthtime());
        Assert.assertEquals(new java.sql.Timestamp(new Date(Long
                .parseLong("13440790653333")).getTime()), p.getAnniversary());
    ...
    private PersonOracleNoSQLAllDataType buildPerson2()
    {
        ...
        PersonOracleNoSQLAllDataType person = new PersonOracleNoSQLAllDataType(1234568l, "ODC", true, 32, 'A', (byte) 10,
    ...
    private void assertPerson2(PersonOracleNoSQLAllDataType p)
    {
        ...
        Assert.assertEquals(new Date(Long
                .parseLong("1344079068266")), p.getEnrolmentTime());
        ...
        Assert.assertEquals(new Long(
                25423452343L), p.getUniqueId());
        Assert.assertEquals(new Double(0.76452343), p.getMonthlySalary());
        Assert.assertEquals(new java.sql.Date(new Date(Long
                .parseLong("1344079064444")).getTime()), p.getBirthday());
        Assert.assertEquals(new java.sql.Time(new Date(Long
                .parseLong("1344079065555")).getTime()), p.getBirthtime());
        Assert.assertEquals(new java.sql.Timestamp(new Date(Long
                .parseLong("1344079066666")).getTime()), p.getAnniversary());
