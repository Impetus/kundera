...
public class StudentOracleNoSQLShortWrapperTest extends OracleNoSQLBase
{
    ...
    public void testPersist(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLShortWrapper studentMax = new StudentOracleNoSQLShortWrapper();
        ...
        StudentOracleNoSQLShortWrapper studentMin = new StudentOracleNoSQLShortWrapper();
        ...
        StudentOracleNoSQLShortWrapper student = new StudentOracleNoSQLShortWrapper();
    ...
    public void testFindById(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLShortWrapper studentMax = em.find(StudentOracleNoSQLShortWrapper.class, getMaxValue(Short.class));
        ...
        StudentOracleNoSQLShortWrapper studentMin = em.find(StudentOracleNoSQLShortWrapper.class, getMinValue(Short.class));
        ...
        StudentOracleNoSQLShortWrapper student = em.find(StudentOracleNoSQLShortWrapper.class, getRandomValue(Short.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLShortWrapper student = em.find(StudentOracleNoSQLShortWrapper.class, getMaxValue(Short.class));
        Assert.assertNotNull(student);
        ...
        StudentOracleNoSQLShortWrapper newStudent = em.find(StudentOracleNoSQLShortWrapper.class, getMaxValue(Short.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        String query;
        Query q;
        List<StudentOracleNoSQLShortWrapper> students;
        int count;
        em = emf.createEntityManager();
        ...
        count = 0;
        for (StudentOracleNoSQLShortWrapper student : students)
        {
    ...
    private void findByRange()
    {
        ...
        List<StudentOracleNoSQLShortWrapper> students;
        em = emf.createEntityManager();
        query = "Select s From StudentOracleNoSQLShortWrapper s where s.id between " + getMinValue(Short.class) + " and "
    ...
    public void testDelete(boolean useSameEm)
    {
        ...
        studentMax = em.find(StudentOracleNoSQLShortWrapper.class, getMaxValue(Short.class));
    ...
    private void deleteNamed(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLShortWrapper newStudent = em.find(StudentOracleNoSQLShortWrapper.class, getRandomValue(Short.class));
    ...
    private void findByNameAndAgeGTAndLT()
    {
        ...
        int count;
        em = emf.createEntityManager();
        query = "Select s From StudentOracleNoSQLShortWrapper s where s.name = Amresh and s.age > " + getMinValue(short.class)
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLShortWrapper> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(3, students.size());
        int count = 0;
        for (StudentOracleNoSQLShortWrapper student : students)
