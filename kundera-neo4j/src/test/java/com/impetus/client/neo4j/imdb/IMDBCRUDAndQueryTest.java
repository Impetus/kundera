...
/**
 * Test case using IMDB example for CRUD and query Demonstrates M-2-M
 * Association between two entitites using Map
 * 
 * @author amresh.singh
 */
public class IMDBCRUDAndQueryTest {
	...
	public void tearDown() throws Exception {
		 ...
		 * ); if(datastoreFilePath != null) FileUtils.deleteRecursively(new
		 * File(datastoreFilePath));
		 */
