...
public class ColumnFamilyProcessor extends AbstractEntityFieldProcessor
{
    ...
    public final void process(Class<?> clazz, EntityMetadata metadata)
    {
        ...
        /*
         * if (!clazz.isAnnotationPresent(ColumnFamily.class)) { return; }
         */
         ...
         * 
         * // set columnFamily metadata.setColumnFamilyName(cf.family());
         * 
         * // set keyspace String keyspace = cf.keyspace().length() != 0 ?
         * cf.keyspace() : em .getKeyspace();
