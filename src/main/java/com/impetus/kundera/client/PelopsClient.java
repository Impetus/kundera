...
public class PelopsClient implements CassandraClient {
	 ...
	 */
	@Override
	public final List<Column> loadColumns(String keyspace, String columnFamily,
		...
		return selector.getColumnsFromRow(rowId, columnFamily, Selector
	 ...
	 */
	@Override
	public final Map<String, List<Column>> loadColumns(String keyspace,
		...
		Selector selector = Pelops.createSelector(poolName, keyspace);
		return selector.getColumnsFromRows(Arrays.asList(rowIds), columnFamily,
