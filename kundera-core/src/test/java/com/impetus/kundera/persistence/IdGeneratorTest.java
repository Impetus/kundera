...
public class IdGeneratorTest
{
            ...
            IllegalAccessException
    {
        ...
        EntityMetadata entityMetadata = KunderaMetadataManager.getEntityMetadata(GeneratedIdStrategyAuto.class);

        // on auto strategy
        idGenerator.generateAndSetId(autoStrategy, entityMetadata, CoreTestUtilities.getDelegator(em));
            ...
            IllegalAccessException
    {
        ...
        EntityMetadata entityMetadata = KunderaMetadataManager.getEntityMetadata(GeneratedIdStrategySequence.class);
            ...
            IllegalAccessException
    {
        ...
        EntityMetadata entityMetadata = KunderaMetadataManager.getEntityMetadata(GeneratedIdStrategyIdentity.class);
            ...
            IllegalAccessException
    {
        ...
        EntityMetadata entityMetadata = KunderaMetadataManager.getEntityMetadata(GeneratedIdStrategyTable.class);
    ...
    private void setInvalidClient(PersistenceDelegator pd) throws NoSuchFieldException, SecurityException
    {
        ...
        clientMap.put(persistenceUnit, new CoreTestClientNoGenerator(null, persistenceUnit));
