...
public class MTMUniAssociationIntTest extends TwinAssociation
{
            ...
            TimedOutException, SchemaDisagreementException
    {
        ...
        // ColumnDef columnDef1 = new
        // ColumnDef(ByteBuffer.wrap("ADDRESS_ID".getBytes()), "Int32Type");
...
//            }
            ...
            TimedOutException, SchemaDisagreementException
    {
        ...
        // ColumnDef columnDef2 = new
        // ColumnDef(ByteBuffer.wrap("PERSON_ID".getBytes()), "Int32Type");
...
//            CassandraCli.client.system_add_column_family(cfDef2);
    ...
    static void loadDataForPersonnelAddress()
    {
        try
        {
            ...
            //
            // ColumnDef columnDef2 = new
            // ColumnDef(ByteBuffer.wrap("ADDRESS_ID".getBytes()),
            // "IntegerType");
            // columnDef2.index_type = IndexType.KEYS;
            // cfDef2.addToColumn_metadata(columnDef2);
