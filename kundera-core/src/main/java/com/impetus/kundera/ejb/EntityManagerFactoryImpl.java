...
public class EntityManagerFactoryImpl implements EntityManagerFactory {
	...
	private void onLoad(String persistenceUnitName) {
		if (persistenceUnitName == null) {
			throw new IllegalArgumentException(
					"Must have a persistenceUnitName!");
		}
		...
		LOG.info("EntityManagerFactoryImpl loaded in "
	...
	public Cache getCache(Class<?> entity) {
		try {
			String cacheName = metadataManager.getEntityMetadata(entity)
					.getEntityClazz().getName();
	...
	public KunderaProxy getLazyEntity(String entityName,
		...
		return lazyInitializerFactory.getProxy(entityName, persistentClass,
