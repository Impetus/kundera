...
import com.impetus.client.oraclenosql.datatypes.entities.StudentOracleNoSQLByteWrapper;

public class StudentOracleNoSQLByteWrapperTest extends OracleNoSQLBase
{
    ...
    public void testPersist(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLByteWrapper studentMax = new StudentOracleNoSQLByteWrapper();
        ...
        StudentOracleNoSQLByteWrapper studentMin = new StudentOracleNoSQLByteWrapper();
        ...
        StudentOracleNoSQLByteWrapper student = new StudentOracleNoSQLByteWrapper();
    ...
    public void testFindById(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLByteWrapper studentMax = em.find(StudentOracleNoSQLByteWrapper.class, getMaxValue(Byte.class));
        ...
        StudentOracleNoSQLByteWrapper studentMin = em.find(StudentOracleNoSQLByteWrapper.class, getMinValue(Byte.class));
        ...
        StudentOracleNoSQLByteWrapper student = em.find(StudentOracleNoSQLByteWrapper.class, getRandomValue(Byte.class));
    ...
    {
        EntityManager em = emf.createEntityManager();
        StudentOracleNoSQLByteWrapper student = em.find(StudentOracleNoSQLByteWrapper.class, getMaxValue(Byte.class));
        Assert.assertNotNull(student);
        ...
        StudentOracleNoSQLByteWrapper newStudent = em.find(StudentOracleNoSQLByteWrapper.class, getMaxValue(Byte.class));
    ...
    private void findByAgeAndNameGTAndLT()
    {
        ...
        String query;
        Query q;
        List<StudentOracleNoSQLByteWrapper> students;
        int count;
        em = emf.createEntityManager();
        ...
        count = 0;
        for (StudentOracleNoSQLByteWrapper student : students)
        {
    ...
    public void testDelete(boolean useSameEm)
    {
        ...
        studentMax = em.find(StudentOracleNoSQLByteWrapper.class, getMaxValue(Byte.class));
    ...
    private void deleteNamed(boolean useSameEm)
    {
        ...
        StudentOracleNoSQLByteWrapper newStudent = em.find(StudentOracleNoSQLByteWrapper.class, getRandomValue(Byte.class));
    ...
    private void findAllQuery()
    {
        ...
        List<StudentOracleNoSQLByteWrapper> students = q.getResultList();
        Assert.assertNotNull(students);
        Assert.assertEquals(3, students.size());
        int count = 0;
        for (StudentOracleNoSQLByteWrapper student : students)
