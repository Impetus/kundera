...
public class PersonCassandraTTLTest extends BaseTest {
    ...
    /**
     * Tests whether TTL provided while inserting records are correctly getting applied for CQL 2.0
     * Common TTL value for entire row is used
     * @throws Exception
     */
    ...
    {   	
        ...
        List<ColumnOrSuperColumn> columnOrSuperColumns = CassandraCli.client.get_slice(key, new ColumnParent("PERSONCASSANDRA"), predicate, ConsistencyLevel.ONE);
        ...
        columnOrSuperColumns = CassandraCli.client.get_slice(key, new ColumnParent("PERSONCASSANDRA"), predicate, ConsistencyLevel.ONE);
        for(ColumnOrSuperColumn cosc : columnOrSuperColumns)
        {
        	Column column = cosc.column;        	
    ...
    /**
     * Tests whether TTL provided while inserting records are correctly getting applied for CQL 2.0
     * Different TTL Values for Different columns are used
     * @throws Exception
     */
    ...
    /**
     * Tests whether TTL provided while inserting records are correctly getting applied using CQL 3
     * Common TTL value for entire row is used
     * @throws Exception
     */    
    @Test
